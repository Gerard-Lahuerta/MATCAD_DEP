================================================================================
    BIBLIOTECA MICROSOFT FOUNDATION CLASS: Información general del proyectoEntornV3D
===============================================================================

El asistente para aplicaciones ha creado esta aplicación EntornV3D. Esta aplicación no solo muestra las bases de la utilización de Microsoft Foundation Classes, también es un punto de partida para escribir la aplicación.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación EntornV3D.
...
EntornV3D.h
    ...
    Incluye otros encabezados específicos del proyecto (incluido Resource.h) y declara la clase de aplicación CEntornV3DApp.

EntornV3D.cpp
    Este es el archivo de código fuente de la aplicación principal que contiene la clase de aplicación CEntornV3DApp.
...
res\EntornV3D.ico
    Este es un archivo de icono, que se usa como el icono de la aplicación. Este icono está incluido en el archivo principal de recursos EntornV3D.rc.
...
res\Toolbar.bmp
    ...
    La barra de herramientas inicial y la barra de estado se crean en la clase CMainFrame. Edite este mapa de bits de la barra de herramientas con el editor de recursos y actualice la matriz IDR_MAINFRAME TOOLBAR en EntornV3D.rc para agregar botones de la barra de herramientas.
/////////////////////////////////////////////////////////////////////////////
...
EntornV3DDoc.h, EntornV3DDoc.cpp: el documento
    Estos archivos contienen la clase CEntornV3DDoc. Edite estos archivos para agregar los datos de documentos especiales e implementar el guardado y la carga de archivos (mediante CEntornV3DDoc::Serialize).

EntornV3DView.h, EntornV3DView.cpp: la vista del documento
    Estos archivos contienen la clase CEntornV3DView.
    Los objetos CEntornV3DView se usan para ver objetos CEntornV3DDoc.

res\EntornV3DDoc.ico
    Este es un archivo de icono, que se usa como icono de las ventanas secundarias de MDI para la clase CEntornV3DDoc. Este icono está incluido en el archivo principal de recursos EntornV3D.rc.
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado EntornV3D.pch y un archivo de tipos precompilados llamado StdAfx.obj.
