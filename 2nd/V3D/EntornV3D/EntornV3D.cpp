// EntornV3D.cpp : define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CEntornV3DApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CEntornV3DApp::OnAppAbout)
...
// Construcción de CEntornV3DApp

CEntornV3DApp::CEntornV3DApp()
{
	...
	SetAppID(_T("EntornV3D.AppID.NoVersion"));

	// TODO: agregar aquí el código de construcción,
	// Colocar toda la inicialización importante en InitInstance
}

// El único objeto CEntornV3DApp

CEntornV3DApp theApp;


// Inicialización de CEntornV3DApp

BOOL CEntornV3DApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_EntornV3DTYPE,
		RUNTIME_CLASS(CEntornV3DDoc),
		RUNTIME_CLASS(CChildFrame), // Marco MDI secundario personalizado
		RUNTIME_CLASS(CEntornV3DView));
	if (!pDocTemplate)
		return FALSE;
...
int CEntornV3DApp::ExitInstance()
{
...
// Controladores de mensaje de CEntornV3DApp
...
void CEntornV3DApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// Métodos para cargar o guardar personalizaciones de  CEntornV3DApp

void CEntornV3DApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CEntornV3DApp::LoadCustomState()
{
}

void CEntornV3DApp::SaveCustomState()
{
}
